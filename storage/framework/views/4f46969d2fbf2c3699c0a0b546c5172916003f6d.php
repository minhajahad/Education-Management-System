...
<?php $__env->startSection('title','Signup Teacher Account'); ?>
...
<div class="container-fluid">
    <div class="row h-50 align-items-center justify-content-center my-4" style="min-height: 30vh;">
        <div class="col-8 col-sm-6 col-md-4 col-lg-4 col-xl-6">
            ...
            <form class="user" method="post" action="<?php echo e(url('/teacher/registration')); ?>">
                <?php echo csrf_field(); ?>
                <h3>Sign Up</h3>
            ...
            <div class="text-center">
                <a class="medium" href="<?php echo e(url('/login')); ?>">Already have an account? Login!</a>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('admin.layouts.single_col', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Spring 2023\SD\xampp\htdocs\sadia\resources\views/admin/pages/auth/teacher_register.blade.php ENDPATH**/ ?>