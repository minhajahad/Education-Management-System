    ...
    <div class="row h-50 align-items-center justify-content-center my-3" style="min-height: 30vh;">
        <div class="col-8 col-sm-6 col-md-4 col-lg-4 col-xl-6">
            <div class="bg-light rounded p-3 p-sm-3 my-1 mx-1">
                ...
                <form class="user" method="post" action="<?php echo e(url('admin/signupStudent')); ?>">
                    <?php echo csrf_field(); ?>
                    <h3>Sign Up</h3>
...
<?php echo $__env->make('admin.layouts.two_col', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Spring 2023\SD\xampp\htdocs\sadia\resources\views/admin/pages/admin/student_signup.blade.php ENDPATH**/ ?>